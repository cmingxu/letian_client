...
public static enum ReturnCode { noPicture, unknown, http201, http400, http401, http403, http404, http500};





public static ReturnCode uploadPicture(String pictureFileName,String postUrl)
{
	


    File uploadFile = new File(IOUtils.data_file_name(pictureFileName)); 
    ...
    if (uploadFile.exists())
        ...
        { 
            ...
            writeFileField("photo", pictureFileName, "image/jpg", fileInputStream ,dataStream);
 ...
 */
private static String getResponseOrig(HttpURLConnection conn)
{
    InputStream is = null;
    try 
    {
    ...
    DataOutputStream dataStream )
{
    ...
    catch(Exception e)
    {
        ...
        Log.e("ss", "writeFormField: got: " + e.getMessage());
    }
}
