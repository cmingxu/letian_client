...
public class LoupanDialog extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        res = Loupan.mingcheng_bianhao_map(this.getApplicationContext());
        listItems.addAll(res.keySet());
     
		final ListView list = (ListView) findViewById(R.id.list);
		adapter = new LoupanListItemsAdapter(listItems);
    ...
    private class CustomOnItemClickListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
	        ...
	        Bundle b = new Bundle();  
	        b.putString("loupan_mingcheng", (String)listItems.get(arg2));  
	        b.putString("loupan_bianhao", res.get(listItems.get(arg2)));
	        b.putInt("type", 1);
	        i.putExtras(b);  
	          
	        LoupanDialog.this.setResult(RESULT_OK, i);  
	        LoupanDialog.this.finish();  
			
		}}
    
	private class LoupanListItemsAdapter extends ArrayAdapter<Object> {
		public LoupanListItemsAdapter(List<Object> items) {
			super(LoupanDialog.this, android.R.layout.simple_list_item_1, items);
		}
	...
	private LoupanListItemsAdapter adapter = null; 
}