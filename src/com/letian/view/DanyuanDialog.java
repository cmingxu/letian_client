...
public class DanyuanDialog extends Activity {
    /** Called when the activity is first created. */

    private TextView unit_chooser_dialog_title;
    private String louceng_mingcheng;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        louceng_mingcheng = getIntent().getExtras().getString("louge_bianhao");
        louge_bianhao = getIntent().getExtras().getString("louge_bianhao");
        louceng_mingcheng = getIntent().getExtras().getString("loucengmingcheng");
        res = Danyuan.mingcheng_bianhao_map(this.getApplicationContext(),louceng_mingcheng,louge_bianhao);
    ...
    private class CustomOnItemClickListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
	        ...
	        Bundle b = new Bundle();  
	        b.putString("danyuan_mingcheng", (String)listItems.get(arg2));  
	        b.putString("danyuan_bianhao", res.get(listItems.get(arg2)));
	      
	        
	        b.putInt("type", 4);
	        i.putExtras(b);  
	          
	        DanyuanDialog.this.setResult(RESULT_OK, i);  
	        DanyuanDialog.this.finish();  
			
		}}
	private class ListItemsAdapter extends ArrayAdapter<Object> {
		public ListItemsAdapter(List<Object> items) {
			super(DanyuanDialog.this, android.R.layout.simple_list_item_1, items);
		}
