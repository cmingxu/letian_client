...
public class User extends Model {
	...
	public VerifiedInfo verify() throws Exception {
...
//					this.password);
//		} catch (LTException e) {// "received authentication challenge is null"
//			if (e
//					.getMessage()
//					.startsWith(
//							"java.io.IOException: Received authentication challenge is null")) {
//				xmlString = "login.error";
...
//		}
		...
		if (xmlString.contains("login.failed")) {
			...
			ret.verifyMessage = "��½ʧ�ܣ������û������롣";
		} else {
			ret.verifyCode = VerifiedInfo.VERIFY_SUCCESS;
			ret.verifyMessage = "��ӭ��½" + this.name;
		}
		return ret;
	}
